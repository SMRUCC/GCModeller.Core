...
#End If
    ...
    Public Sub Frequency(<Parameter("Path.Fasta")> Fasta As String, Optional offset As Integer = 0)
        ...
        Call doc.AppendLine(String.Join(",", data.First.Value.Keys.ToArray(Of String)(Function(c) CStr(c))))
        Call doc.AppendLine(String.Join(vbCrLf, data.ToArray(Of String)(Function(obj) $"{obj.Key + offset },{String.Join(",", obj.Value.ToArray(Of String)(Function(oo) CStr(oo.Value)))}")))
